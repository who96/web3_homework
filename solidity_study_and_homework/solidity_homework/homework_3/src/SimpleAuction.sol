...
contract SimpleAuction is ReentrancyGuard, Ownable {
    struct Auction {
        address nftContract;
        uint256 tokenId;
        address seller;
    ...
    AuctionPriceFeed public immutable PRICE_FEED;
    ...
    constructor(address _priceFeed, address _platformWallet) Ownable(msg.sender) {
